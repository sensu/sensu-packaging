...
function(create_cpack_publish_package_target _pc_user _pc_repo _pc_distro _sensu_pkg_name)
    ...
    separate_arguments(_packagecloud_push_cmd UNIX_COMMAND "packagecloud push --skip-exists ${_pc_user}/${_pc_repo}/${_pc_distro} ${_sensu_pkg_name}")    add_custom_command(OUTPUT ${_pc_output}
