function(build_sensu_cli_packages)
    set(_app_name "sensu_cli")
    set(_pkg_type "cli")
...
# Set cli settings that will be used across all cli packages (can be overridden)
function(set_sensu_cli_settings)
    setg(CPACK_PACKAGE_NAME "sensu-go-cli")
    setg(PACKAGE_DESCRIPTION "Sensu Go CLI tools")
...
function(set_sensu_cli_rpm_overrides)
    ...
    setg(CPACK_RPM_POST_UNINSTALL_SCRIPT_FILE "${cli_rpm_hooks_path}/after-remove")
endfunction()

# Set/Override CPACK_DEB settings for cli packages
function(set_sensu_cli_deb_overrides)
    ...
    list(APPEND CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA "${cli_deb_hooks_path}/postrm")
